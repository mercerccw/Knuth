...
<%--            <label for="currentPage"><input type="number" name="currentPage" id="currentPage" required></label>--%>
<%--            <label for="vesselsPerPage"><input type="number" name="vesselsPerPage" id="vesselsPerPage" required></label>--%>
<%--            <input type="submit" name="submit" value="submit"/>--%>
<%--        </form>--%>
<%--        <p>${currentPage}, ${numOfPages}, ${vesselsPerPage}</p>--%>
<%--        <p> ${numberOfVessels} </p>--%>
<%--    </div>--%>
